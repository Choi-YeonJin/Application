...
class CustomContractBottomSheetDialog : BottomSheetDialogFragment() {
    ...
    class CustomBottomSheetDialogBuilder() {
        private val dialog = CustomContractBottomSheetDialog()
        ...
        fun create(): CustomContractBottomSheetDialog {
            return dialog
        }
    }
}